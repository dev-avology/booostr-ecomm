               ...
               <div class="card">
                  <div class="card-body">
                    ...
                    <div class="from-group row mb-2">
                        ...
                        <div class="col-lg-12">
                           <input type="text" value="{{ $weight_type->value ?? '' }}" name="weight_type" class="form-control" placeholder="Kilogram (kg)">
                        </div>
                    </div>
                  </div>
               </div>
               ...
               <div class="card">
                  <div class="card-body">
                    <div class="from-group row mb-2">
                        ...
                        <div class="col-lg-12">
                            <input type="text" name="currency_name" value="{{ $currency_info->currency_name ?? '' }}" class="form-control" required="">
                        </div>
                    </div>
                    <div class="from-group row mb-2">
                        <label for="" class="col-lg-12">{{ __('Currency icon') }} : </label>
                        <div class="col-lg-12">
                            <input type="text" name="currency_icon" value="{{ $currency_info->currency_icon ?? '' }}" class="form-control" required="">
                        </div>
                    </div>
                    @php
                    ...
                    <div class="from-group row mb-2">
                        ...
                        <div class="col-lg-12">
                           <select class="form-control selectric" name="currency_position">
