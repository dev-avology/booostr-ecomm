...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Brands','button_name'=> 'Create New','button_link'=> url('seller/brand/create')])
@endsection
                                ...
                                <tr>
                                  ...
                                  <td class="">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start">
                                        <a class="dropdown-item has-icon text-warning" href="{{ route('seller.brand.edit', $row->id) }}"><i class="fa fa-edit"></i>{{ __('Edit') }}</a>
