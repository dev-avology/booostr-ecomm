				...
				<div class="main-content">
								...
								<div class="row align-items-center">
									<div class="col-lg-5 col-md-5 col-12">
										<div class="item-image">
											...
											<div class="content">
												<h3 class="title"><a href="javascript:void(0)" class="add_to_cart_modal" data-id="{{ $row->term->id }}">{{ $row->term->title ?? '' }}</a> </h3>
					...
					<div class="customer-order-details order-map mt-30">
						...
						<div class="order-map-inner">
							<div class="mapouter"><div class="gmap_canvas h-300" id="map"></div></div>
						</div>
					</div>
					@endif
					@endif
