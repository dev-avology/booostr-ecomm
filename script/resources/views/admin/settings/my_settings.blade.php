                ...
                <form method="post" id="ajaxform"  action="{{ route('admin.users.genupdate') }}">
                    ...
                    <div class="custom-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" readonly id="name" class="form-control" required placeholder="Enter User's  Name" value="{{ $info->name }}">
                        </div>
                        <div class="form-group">
                            <label for="email">{{ __('Email') }}</label>
                            <input type="text" name="email" readonly id="email" class="form-control" required placeholder="Enter Email"  value="{{ $info->email }}">
                        </div>
