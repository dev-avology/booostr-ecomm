...
<body style="background-color: #f4f6f9;">
    <div class="table-wrapper"
        style="width: 100%;max-width: 700px;margin: 0 auto;border-radius: 20px;overflow: hidden;">
                    ...
                    <th style="width: 15%; text-align: left; padding: 40px 0 0 20px;border-collapse: collapse;">
                        {{-- <img src="./img/Champs-Sports-Logo.png" alt="logo"
                            ...
                            @if (!empty(tenant()->logo))
                              <img src="{{ env('WP_URL') }}{{ tenant()->logo }}" alt="logo" style="width: 100%; max-width: 120px; margin-bottom: -15px;position: relative;z-index: 9;"/>
                            @endif
                    </th>
                    ...
                    <td style="width: 100%; padding-left: 15px;font-size: 15px; padding-right: 15px;"
                     ...
                     @endphp
                        ...
                        <p
                           ...
                           Hi {{ $firstName }} we are sorry that your order had to be cancelled. We have refunded your order. Your orginal order details are below for your records. You should see the funds returned to the payment method used for the order in 3-5 business days.</p>
                        @endif
                        ...
                        <p
                            style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-weight: 500;">
                           Hi {{ $firstName }} ,we are excited to let you know that you order from {{ $invoice_info->store_legal_name ?? '' }} has shipped! Your shipping carrier and tracking information are below.</p>
                        @endif
                    </td>
                </tr>
            </tbody>
            ...
            <table style="width: 100%;max-width: 700px; margin: 0 auto; background-color: #fff;">
                <tbody>
                    <tr class="border-style">
                        ...
                        font-size: 17px;
                        color: #3c3c3c;
                        text-transform: uppercase;padding-left: 20px;">SHIPPER:</h4>
                            <p
                                style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-weight: 500;">
                                {{ $data['data']['shippingwithinfo']->shipping_driver ?? '' }}</p>
                        </td>
                        <td style="width: 50%;padding-left: 15px; font-size: 15px; text-align: left;"
                            class="spac-top spac-btm">
                            <h4 style="font-weight: 700;
                        ...
                        font-size: 17px;
                        color: #3c3c3c;
                        text-transform: uppercase;padding-left: 20px;">TRACKING #:</h4>
                            <p
                                style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-weight: 500;">
                                {{ $data['data']['shippingwithinfo']->tracking_no ?? '' }}</p>
                        </td>
                    </tr>
                </tbody>
            </table>
       ...
       @endphp
            ...
            <table style="width: 100%;max-width: 700px; margin: 0 auto; background-color: #fff;">
                <tbody>
                    <tr class="border-style">
                        ...
                        font-size: 17px;
                        color: #3c3c3c;
                        text-transform: uppercase;padding-left: 20px;">CANCELED & REFUNDED</h4>
                            <p
                                style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-weight: 500;">
                        ...
                        font-size: 17px;
                        color: #3c3c3c;
                        text-transform: uppercase;padding-left: 20px;">REFUND AMOUNT</h4>
                            <p
                                style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-weight: 500;">
                                ${{  $amountRefunded ?? '' }}</p>
                        </td>
            ...
            <tbody>
                <tr class="border-style">
                    <td style="width: 50%;padding-left: 15px; font-size: 15px; text-align: left;"
                        ...
                        <p
                            style="font-weight: bold; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c; margin: 0;padding-left: 20px">
                            Date Placed: <span style="font-weight: 500;"> {{ $order->created_at->format('d-m-Y') ?? ''}}</span>
                        </p>
                    </td>
                    <td style="width: 50%;padding-left: 15px; font-size: 15px; text-align: left;"
                        class="spac-top spac-btm">
            ...
            <tbody>
                <tr class="border-style">
                    ...
                    <td style="width: 50%;padding-left: 15px;font-size: 15px; padding-right: 15px;"
                        ...
                        <p style="padding-left: 20px;font-weight:500; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-size: 16px;text-transform: capitalize;
                        ">Status: <span>Authorized</span></p>
                        <p style="padding-left: 20px;font-weight:500; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-size: 16px;text-transform: capitalize;
                        ">Card: <span>{{$data['data']->card_number ?? ''}}</span></p>
                        <p style="padding-left: 20px;font-weight:500; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-size: 16px;text-transform: capitalize;
                        ">Name: <span>{{ $ordermeta->name ?? '' }}</span></p>
                        <p style="padding-left: 20px;font-weight:500; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-size: 16px;text-transform: capitalize;
                        ">Amount: <span>{{ currency_formate($order->total) }}</span></p>
                        {{-- <p style="padding-left: 20px;font-weight:500; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;font-size: 16px;text-transform: capitalize; --}}
                        {{-- ">status: <span>xyz</span></p> --}}
            ...
            <tbody>
                <tr class="border-style">
                    ...
                    <td style="width: 50%;padding-left: 15px;font-size: 15px; padding-right: 15px;"
                        ...
                        "> {{ $data['data']['shippingwithinfo']->shipping_driver ?? '' }}<br>
        ...
        <table style="width: 100%;max-width: 700px; margin: 0 auto; background-color: #fff;">
            <tbody>
                ...
                <tr class="border-style">
                    <td style="padding-left: 15px;width: 40%;" class="spac-top spac-btm">
                        <h5
                            style="font-weight: 700; font-family: 'Nunito', 'Segoe UI', Arial;font-size: 17px;color: #3c3c3c;padding-bottom: 20px;padding-left: 20px;">
                            Product</h5>
                        <p style="padding-left: 20px;
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">antheumea</p>
                        <p style="
                        padding-left: 20px;
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">item #2</p>
                    </td>
                    <td style="padding-left: 15px;width: 20%;" class="spac-top spac-btm">
                        <h5
                            style="font-weight: 700; font-family: 'Nunito', 'Segoe UI', Arial;font-size: 17px;color: #3c3c3c;    padding-bottom: 20px; ">
                            Price</h5>
                        <p style="
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">23.00</p>
                        <p style="
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">17.00</p>
                    </td>
                    <td style="padding-left: 15px;width: 20%;" class="spac-top spac-btm">
                        <h5
                            style="font-weight: 700; font-family: 'Nunito', 'Segoe UI', Arial;font-size: 17px;color: #3c3c3c;    padding-bottom: 20px; ">
                        ...
                        <p style="
                            ...
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">5.00</p>
                        <p style="
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;">25.00</p>
                    </td>
                    <td style="padding-left: 15px;width: 20%;" class="spac-top spac-btm">
                        <h5
                            style="font-weight: 700; font-family: 'Nunito', 'Segoe UI', Arial;font-size: 17px;color: #3c3c3c;padding-bottom: 20px;">
                        ...
                        <p style="
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;font-weight: 500;">antheumea</p>
                        <p style="
                            font-weight: 500;
                            font-family: 'Nunito', 'Segoe UI', Arial;
                            color: #3c3c3c;
                            font-size: 16px;padding-bottom: 10px;font-weight: 500;">35.00</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <table style="width: 100%;max-width: 700px; margin: 0 auto; background-color: #fff;">
            <tbody>
                ...
                padding-right: 20px;width: 30%;" class="spac-top">
                    ...
                    font-family: 'Nunito', 'Segoe UI', Arial;
                    color: #3c3c3c;
                    font-size: 16px;font-weight: 500;"> $0.00</p>
                    </td>
                </tr>
                <tr>
            ...
            <tbody>
                <tr class="border-style">
                    <td style="width: 100%;padding-left: 15px;font-size: 15px; padding-right: 15px;"
                        class="spac-top spac-btm">
                        <p
                            style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;    font-weight: 500;">If you have questions about your order ,please don't hesitate to reach out. You will recieve an email confirmation once your order has shipped.</p>

                        <p style="padding-left: 20px;margin: 0; font-family: 'Nunito', 'Segoe UI', Arial; color: #3c3c3c;    font-weight: 500;padding-top: 20px;
                            padding-bottom: 20px;">
                            Thank You,
                        </p>
                        <p
        ...
        <table style="width: 100%;max-width: 700px; margin: 0 auto; background-color: #fff;">
            <tbody>
                ...
                border-radius: 15px 15px 0 0;">
                    <td style="width: 30%;">
                        <h6 style="font-family: 'Nunito', 'Segoe UI', Arial;font-size: 17px;
                        color: #fff;
                        padding-bottom: 10px;">Powered By:</h6>
                        <img src="./img/Champs-Sports-Logo.png" alt="logo" style="width: 100%;max-width: 115px;">
                    </td>
                    <td>
                        <p style="font-family: 'Nunito', 'Segoe UI', Arial;font-size: 13px;
                        color: #fff;
                        font-weight: 300;">{{ $invoice_info->store_legal_name ?? '' }} Store</p>
                        <p style="font-family: 'Nunito', 'Segoe UI', Arial;font-size: 14px;
                        color: #fff;
                        font-weight: 300;">Lorem <a href="" style="font-family: 'Nunito', 'Segoe UI', Arial;font-size: 14px;
                        color: #fff;
                        font-weight: 300;">utilizes Booostr</a>to help them manage their organization, communication with their team and supporters and raise money online.<a>Learn more here</a></p>
                    </td>
                </tr>
            </tbody>
        </table>
