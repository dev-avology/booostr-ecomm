...
<input type="hidden" id="dashboard_static" value="<?php echo e(url('/admin/dashboard/static')); ?>">
<input type="hidden" id="dashboard_perfomance" value="<?php echo e(url('/admin/dashboard/perfomance')); ?>">
<input type="hidden" id="deposit_perfomance" value="<?php echo e(url('/admin/dashboard/deposit/perfomance')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\booostr-ecomm\script\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>