...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard.index')): ?>
    <li class="active">
        <a class="nav-link" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-tachometer-alt"></i>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.list', 'admin.list')): ?>
<li
   class="dropdown <?php echo e(Request::is('admin/role*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/users*') ? 'active' : ''); ?>">
   <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i
      class="fas fa-user-shield"></i><span><?php echo e(__('Admins Users')); ?></span></a>
   <ul class="dropdown-menu">
      <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.list')): ?>
      <li>
         <a class="nav-link" href="<?php echo e(route('admin.role.index')); ?>"><?php echo e(__('Roles')); ?></a>
      </li>
      <?php endif; ?> -->
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.list')): ?>
      <li><a class="nav-link" href="<?php echo e(route('admin.admin.index')); ?>"><?php echo e(__('Admins')); ?></a>
      </li>
      <?php endif; ?>
   </ul>
</li>
...
</li>*/?><?php /**PATH D:\wamp64\www\booostr-ecomm\script\resources\views/admin/adminmenu.blade.php ENDPATH**/ ?>