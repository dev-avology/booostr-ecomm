        ...
        if ($('.category_section').length != 0) {
         ...
         if (response.random_products.length != 0) {
            ...
            $.each(response.productmenu, function(key, category) {
              var html=` <li><a class="list-group-item  filteredtab filterproducts filter_product${category.id}" data-id="${category.id}" data-items="[]" data-bs-toggle="list" href="#f-tab2" role="tab"><img src="${category.icon != null ? category.icon.content : ''}" alt="">${escapeHtml(category.name)}</a></li>`;
            ...
            <div class="row">
               <div class="col-lg-5 col-md-6 col-12">
                  ...
                  <div class="hero-content">
                     <h1 class="slider-title">${escapeHtml(row.title)}</h1>
                     <p>${escapeHtml(row.description)}</p>
                     <div class="buttons">
                        <a href="${row.link}" class="theme-btn">${escapeHtml(row.button_text)}</a>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="features-banner overlay-simple">
                     <div class="feature-img">
                        ...
                        <div class="feature-content">
                           <h3>${escapeHtml(row.title)} <span class="font-style">${escapeHtml(row.description)}</span></h3>
                           ${button}
                        </div>
                     </div>
                  </div>
      ...
      var html=`<div class="col-lg-6 col-md-6 col-12 wow fadeInUp"  data-wow-delay=".4s">
            <div class="single-blog m-top-30">
               ...
               <div class="blog-content">
                  <h3 class="blog-title"><a href="${row.url}">${escapeHtml(row.title)}</a></h3>
                  <p>${escapeHtml(row.short_description)} </p>
                  <div class="blog-btm-meta flex">
                     <div class="meta-btm m-date"><span class="pr-color"><i class="icofont-calendar"></i></span>${escapeHtml(row.time)}</div>
                  </div>
               </div>
            </div>
         </div>`;
                     ...
                     <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-12">
                           <div class="section-title m-btm-30">
                              ...
                              <h2 class="s-content-title font-stylish m-btm-10 pr-color">${escapeHtml(row.name)}</h2>
                           </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
